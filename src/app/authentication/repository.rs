...
impl AuthenticationRepository {
    ...
    pub async fn get_refresh_token_by_hash(&self, refresh_token_hash: &str) -> Option<RefreshToken> {
    ...
    pub async fn delete_refresh_token(&self, token_hash: &str) -> Result<(), AuthTokenError> {
    ...
    pub async fn get_api_key_by_hash(&self, key_hash: &str) -> Option<ApiKey> {
    ...
    pub async fn delete_api_key(&self, user_id: &str, key_id: &str) -> Result<(), ApiKeyError> {
        let result = sqlx::query(
            r"
