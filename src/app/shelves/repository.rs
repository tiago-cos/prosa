...
impl ShelfRepository {
    ...
    pub async fn update_shelf(&self, shelf_id: &str, name: &str) -> Result<(), ShelfError> {
        let result = sqlx::query(
            r"
            UPDATE shelf
            SET name = $1
    ...
    pub async fn get_shelf_book_count(&self, shelf_id: &str) -> i64 {
    ...
    pub async fn add_book_to_shelf(&self, shelf_id: &str, book_id: &str) -> Result<(), ShelfBookError> {
        sqlx::query(
            r"
    ...
    pub async fn get_shelf_books(&self, shelf_id: &str) -> Vec<String> {
        sqlx::query_scalar(
            r"
            SELECT book_id
            FROM is_in_shelf
    ...
    pub async fn delete_book_from_shelf(&self, shelf_id: &str, book_id: &str) -> Result<(), ShelfBookError> {
        let result = sqlx::query(
            r"
