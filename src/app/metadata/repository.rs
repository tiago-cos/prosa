...
impl MetadataRepository {
    ...
    pub async fn get_metadata(&self, metadata_id: &str) -> Result<Metadata, MetadataError> {
    ...
    pub async fn add_metadata(&self, metadata_id: &str, metadata: &Metadata) -> Result<(), MetadataError> {
    ...
    pub async fn delete_metadata(&self, metadata_id: &str) -> Result<(), MetadataError> {
    ...
    pub async fn update_metadata(&self, metadata_id: &str, metadata: &Metadata) -> Result<(), MetadataError> {
        let mut tx = self.pool.begin().await?;
